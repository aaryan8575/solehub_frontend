...
export const StoreProvider = ({ children }: StoreProps) => {
  ...
  const createNewCart = async (regionId?: string) => {
    console.log("create cart", process.env.NEXT_PUBLIC_SALES_CHANNEL_ID)
  ...
  const resetCart = () => {
    ...
    console.log("reset cart", process.env.NEXT_PUBLIC_SALES_CHANNEL_ID)
  ...
  const updateItem = ({ lineId, quantity, callback }: LineInfoProps) => {
