          ...
          {cart && cart.payment_session && (
            <div className="flex items-start gap-x-1 w-full">
              <div className="flex flex-col gap-2 w-1/3">
                <p className="text-caption2 font-semibold">Payment method</p>
              ...
              <div className="flex flex-col gap-2 w-1/3">
                <p className="text-caption2 font-semibold">Payment details</p>
                <div className="flex gap-2 txt-medium items-center">
                  <div className="flex items-center h-7 w-fit p-2 bg-primary text-white rounded-md shadow-md">
