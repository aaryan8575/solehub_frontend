...
const CounterBtn = ({
  ...
  return (
    <div
      className={clsx(
        "grid max-sm:py-0 py-[0.2rem] grid-cols-3 gap-2 sm:gap-4 items-center justify-center place-items-center border border-black rounded-lg overflow-hidden ",
        {
          "w-full": size === "md",
          "w-max": size === "sm",
        }
    ...
    >
      <button
        ...
        className={clsx(
          [
            " disabled:opacity-20  disabled:cursor-not-allowed hover:text-primary duration-300",
            className,
          ],
          {
            "px-2": size === "md",
        ...
        onClick={cartItem?.quantity != 0 ? decreaseQuantity : openModal}
        disabled={!!loading}
        type="button"
      >
...
//     <div
//       className={clsx(
//         "flex gap-2 sm:gap-4 items-center justify-between border border-black rounded-lg overflow-hidden ",
//         {
//           "w-full": size === "md",
//           "w-max": size === "sm",
//         }
